...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/24066cf7e315e12d3ac38.jpg'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001983630683') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001806978974') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002108499060') # request channel id ( make sure bot is admin )
...
PROTECT_CONTENT = is_enabled((environ.get('PROTECT_CONTENT', "0")), True)
...
URL = "https://premiumb9t-a03930d55f51.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://premiumb9t-a03930d55f51.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://premiumb9t-a03930d55f51.herokuapp.com/".format(FQDN)
else:
    URL = "https://premiumb9t-a03930d55f51.herokuapp.com/".format(FQDN)

# add premium logs channel id
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001995773499'))
